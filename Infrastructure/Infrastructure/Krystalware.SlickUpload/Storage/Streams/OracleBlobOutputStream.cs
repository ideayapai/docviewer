...
namespace Krystalware.SlickUpload.Storage.Streams
{
	...
	/// </summary>
	public sealed class OracleBlobOutputStream : Stream
	{
		IDbConnection _cn;
		IDbCommand _cmd;
		...
		public OracleBlobOutputStream(string connectionString, string table, string dataField, string idField, int idValue) : 
