...
namespace Documents.Converter.Imp
{
    ...
    /// Office->PDF->SWF
    /// </summary>
    public class PPTToSwfConverter : IConverter
    {
        private readonly PPTToPdfConverter _wordToPdfConverter = new PPTToPdfConverter();
        ...
        {
            _logger.DebugFormat("转换PPT为SWF, {0} 到 {1}", from, to);
