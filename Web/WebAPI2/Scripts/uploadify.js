    ...
    var handlers = {
        ...
        onSelect: function (file) {
            ...
            for (var n in this.queueData.files) {
                ...
                //console.log(queuedFile.name);
                if (queuedFile.uploaded != true && queuedFile.name == file.name) {
                    var replaceQueueItem = confirm('文件名\n "' + file.name + '" \n已在队列中.\n您确认要覆盖现有文件吗?');
                    if (!replaceQueueItem) {
            ...
            if (settings.itemTemplate == false) {
                settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
					<div class="cancel">\
						<a name="uploaddeletebtn" href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')" class="uploadify-delete_link"></a>\
					</div>\
