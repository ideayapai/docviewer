...
namespace Infrasturcture.Store.Utils
{
    public static class MimeMapper
    {
        ...
        static MimeMapper()
        {
            _mimeMappingTable = new Hashtable(StringComparer.CurrentCultureIgnoreCase);
            ...
            AddMimeMapping(".pptx", "application/mspowerpoint");
            ...
            AddMimeMapping(".dwg", "application/autocad");
