...
function settingUpload(htmlid, userid, username, spaceid) {
    ...
    ({
        ...
        'uploader': apiUrl + '/Document/Add', //设置上传的Url接口Document/Add
        'cancelImg': apiUrl + '/images/cancel.png',//TODO:BUG
        ...
        'onUploadStart': function (file) {
            var treeObj = $.fn.zTree.getZTreeObj("uploadTree");
            var nodes = treeObj.getSelectedNodes();
            $("#" + htmlid).uploadify("settings", "formData", { 'userId': userid, 'UserName': username, 'SpaceId': nodes[0].xid });
        },
...
function DeleteUploadedFile(htmlid,fileid, dataid) {
    ...
    $.ajax({
        url: apiUrl + "/Document/Delete?fileId=" + dataid,
        type: 'POST',
        dataType: "text",
        success: function (e) {
...
function RecoverUploadedFile() {
    ...
    //Ajax请求删除ID
    $.ajax({
        url: apiUrl + "/Document/Recover?fileId=" + $.trim($("#recoverfileid").val()),
        type: 'POST',
        dataType: "json",
        success: function (e) {
            alert('回收成功');
...
function GetUploadedFile() {
    ...
    //Ajax请求删除ID
    $.ajax({
        url: apiUrl + "/Document/Get/" + $("#getfileid").val(),
        type: 'GET',
        dataType: "text",
        success: function (e) {
